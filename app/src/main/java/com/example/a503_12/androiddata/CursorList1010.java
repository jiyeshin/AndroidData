...
public class CursorList1010 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cursor_list1010);
        ...
        //데이터베이스 사용 클래스의 객체 생성 - 여기서 this는 onCreate. 즉, onCreate가 호출
